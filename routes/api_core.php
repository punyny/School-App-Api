...
Route::middleware(['auth:sanctum', 'role:super-admin', 'admin.ip'])->group(function (): void {
...
Route::middleware(['auth:sanctum', 'role:super-admin,admin', 'admin.ip'])->group(function (): void {
...
Route::middleware(['auth:sanctum', 'role:super-admin,admin,teacher,student,parent', 'admin.ip'])->group(function (): void {
...
Route::middleware(['auth:sanctum', 'role:super-admin,admin,teacher,student', 'admin.ip'])->group(function (): void {
...
Route::middleware(['auth:sanctum', 'role:student,parent', 'admin.ip'])->group(function (): void {
    Route::post('/leave-requests', [LeaveRequestController::class, 'store'])
        ->middleware('can:create,'.\App\Models\LeaveRequest::class);
});

Route::middleware(['auth:sanctum', 'role:super-admin,admin,teacher', 'admin.ip'])->group(function (): void {
...
Route::middleware(['auth:sanctum', 'role:student,parent'])->group(function (): void {
